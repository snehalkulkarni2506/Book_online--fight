...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { From_To: @travel.From_To, contact: @travel.contact, fare: @travel.fare, name: @travel.name, timing: @travel.timing } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { From_To: @travel.From_To, contact: @travel.contact, fare: @travel.fare, name: @travel.name, timing: @travel.timing } }
